...
/**
 * CodahaleMetric - com.codahale.metrics based Metric implementation.
 * <p/>
 * It may report the cummulated metrics to both the current log or platform JMX server.
 *
 * @author Vlad Mihalcea
 */
public class CodahaleMetric implements Metric {

    private final static Logger log = LoggerFactory.getLogger(CodahaleMetric.class);
    ...
    public CodahaleMetric(String domain) {
        this.domain = domain;
    ...
    public CodahaleMetric(Class<?> clazz, String uniqueName) {
