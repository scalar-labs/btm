...
public class JdbcPreparedStatementHandle extends BaseProxyHandlerClass { // implements PreparedStatement
    ...
    private volatile PreparedStatement delegate;
    private volatile boolean pretendClosed = false;

    // The 'parent' connection. Used to return the connection to the pool upon
    // close().
    private volatile JdbcPooledConnection parentConnection;
    ...
    private volatile int resultSetType = ResultSet.TYPE_FORWARD_ONLY;
    private volatile int resultSetConcurrency = ResultSet.CONCUR_READ_ONLY;
    private volatile Integer resultSetHoldability;
    private volatile Integer autoGeneratedKeys;
    private volatile int[] columnIndexes;
