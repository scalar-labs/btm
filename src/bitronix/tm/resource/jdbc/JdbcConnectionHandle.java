...
public class JdbcConnectionHandle implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        if (useStatementCache) {
            ...
            stmt = getPooledConnection().getCachedStatement(proposedStmt);
            if (stmt == null) {
                stmt = getDelegate().prepareStatement(sql);
                proposedStmt.setDelegate(stmt);
                stmt = getPooledConnection().putCachedStatement(proposedStmt);
            }
            proposedStmt.setPooledConnection(getPooledConnection());
        }
        else {
