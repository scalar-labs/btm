...
public class JdbcConnectionHandle implements Connection {
    ...
    public Statement createStatement() throws SQLException {
        ...
        Statement stmt = getDelegate().createStatement();
        jdbcPooledConnection.registerStatement(stmt);
        return stmt;
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        ...
        Statement stmt = getDelegate().createStatement(resultSetType, resultSetConcurrency);
        jdbcPooledConnection.registerStatement(stmt);
        return stmt;
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        ...
        Statement stmt = getDelegate().createStatement(resultSetType, resultSetConcurrency, resultSetHoldability);
        jdbcPooledConnection.registerStatement(stmt);
        return stmt;
    }
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        ...
        CallableStatement stmt = getDelegate().prepareCall(sql);
        jdbcPooledConnection.registerStatement(stmt);
        return stmt;
    }
    ...
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        ...
        CallableStatement stmt = getDelegate().prepareCall(sql, resultSetType, resultSetConcurrency);
        jdbcPooledConnection.registerStatement(stmt);
        return stmt;
    }
    ...
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        ...
        CallableStatement stmt = getDelegate().prepareCall(sql, resultSetType, resultSetConcurrency, resultSetHoldability);
        jdbcPooledConnection.registerStatement(stmt);
        return stmt;
    }
