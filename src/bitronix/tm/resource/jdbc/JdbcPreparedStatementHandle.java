...
public class JdbcPreparedStatementHandle extends BaseProxyHandlerClass { // implements PreparedStatement
	 ...
	 *            the parent JdbcPooledConnection
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!sql.equals(otherStmt.sql)) {
			...
			return false;
				...
				|| (autoGeneratedKeys != null && !autoGeneratedKeys
						.equals(otherStmt.autoGeneratedKeys))) {
			return false;
		} else if ((resultSetHoldability == null && otherStmt.resultSetHoldability != null)
				|| (resultSetHoldability != null && !resultSetHoldability
						.equals(otherStmt.resultSetHoldability))) {
			return false;
		}
